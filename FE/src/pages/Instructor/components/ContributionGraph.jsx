export default function ContributionGraph({ buckets = [] }) {
        ...
        {buckets.map((b, i) => {
          ...
          return (
            <div key={i} className="group relative flex-1 flex flex-col justify-end h-full">
              ...
              />
              <div className="opacity-0 group-hover:opacity-100 absolute bottom-full mb-2 left-1/2 -translate-x-1/2 z-10 pointer-events-none whitespace-nowrap bg-slate-800 text-white text-[10px] px-2 py-1 rounded shadow-lg transition-opacity">

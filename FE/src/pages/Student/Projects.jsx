...
export default function Projects() {
  ...
  return (
    <div className="min-h-screen bg-(--page-bg) text-(--text-primary) font-sans pb-12">
      ...
      <main className="max-w-[1400px] 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        {/* Welcome Header */}
        ...
        {loading ? (
          ...
          /* Grid View Layout */
          <div id="projects-grid" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">

      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-(--surface) rounded-2xl shadow-sm border border-(--border-light) p-6 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-(--surface-secondary) p-4 rounded-xl border border-(--border-light) flex gap-3">
            ...
            <div data-guide="overview-projects" className="bg-(--surface-secondary) p-4 rounded-xl border border-(--border-light) flex gap-3">

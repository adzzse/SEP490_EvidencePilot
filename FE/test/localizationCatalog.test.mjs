...
const INSTRUCTOR_REVIEW_KEYS = [
  ...
  'confirmation', 'contextMode', 'currentSection',
  ...
  'generateSuggestions', 'generatingSuggestions', 'historicalRoundNotice', 'historyEmpty',
  ...
  'rejectConfirm', 'rejectSubmission', 'reviewGuide', 'reviewOverview', 'reviewRejected', 'reviewReturned', 'reviewRound',
  'saveFeedbackFailed', 'sectionChanged', 'sectionFeedback', 'sectionFeedbackPlaceholder', 'sectionOverview', 'selectionReady', 'selectSectionFeedback', 'selectSectionGuide',

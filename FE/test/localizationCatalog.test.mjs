...
const INSTRUCTOR_REVIEW_KEYS = [
  ...
  'aiSuggestions', 'aiSuggestionTab', 'aiSuggestionWorkerUnavailable', 'allFeedback', 'approve', 'commentSelection',
  'confirmation', 'contextMode', 'currentSection', 'composerPlaceholder',
  'deleteFeedbackConfirm', 'deleteFeedbackFailed', 'doneFeedback', 'draft', 'draftBadge', 'edit', 'finalizeReviewConfirm',
  ...
  'previousRoundOpen', 'rejectConfirm', 'rejectNotePlaceholder', 'rejectNoteRequired', 'rejectSubmission', 'rejectThread',
  'reanchorBanner', 'reanchorSameSection', 'reanchorThread',
  'reopenFeedback', 'reopenThread', 'replyFailed', 'replyPlaceholder', 'resolveThread', 'returnForRevision', 'reviewApproved', 'reviewClosed',
  ...
  'selectSourceRange', 'selectSubmittedSource', 'sendReply', 'showChanges', 'snapshotLoadError', 'stateOpen', 'stateRejected', 'stateResolved',
  'addComment', 'lockAnchor', 'lockAnchorHere', 'previewUnavailableAction', 'previewUnavailableTitle',
  'submittedVersion',
...
const DYNAMIC_KEY_DOMAINS = new Map([
  ...
  ['instructor.review.state', ['Open', 'Resolved', 'Rejected']],

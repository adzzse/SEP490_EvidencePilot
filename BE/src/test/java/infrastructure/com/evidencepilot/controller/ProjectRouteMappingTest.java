...
class ProjectRouteMappingTest {
    ...
    void exposesExactlyTheDocumentedRoutes() {
        ...
        assertThat(routes).containsExactlyInAnyOrderElementsOf(Set.of(
                ...
                "GET /api/projects/{projectId}/source-map",
                ...
                "PATCH /api/projects/{id}/members/{userId}/unassign-all",
                ...
                "GET /api/papers/{paperId}/references",
                ...
                "POST /api/sources/projects/{projectId}/unshare",
                "PUT /api/sources/{id}",
                ...
                "GET /api/feedback-requests/{id}/comparison-source",
                "GET /api/projects/{projectId}/review-readiness",
                ...
                "GET /api/admin/projects/{id}/sections-count",
                "GET /api/admin/projects/{id}/sections",
                "PATCH /api/admin/projects/{id}/archive",
                "PATCH /api/admin/projects/{id}/unarchive",
                ...
                "POST /api/papers/{documentId}/sections/{sectionId}/handoff",
                "DELETE /api/papers/{documentId}/sections/{sectionId}/handoff",
